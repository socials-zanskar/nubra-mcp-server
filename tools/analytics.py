...
def register(mcp: Any, service: NubraService) -> None:
    ...
    def find_symbols_with_rising_greeks(
        ...
        """For a list of symbols, use ATM option historical Greeks to identify rising delta and vega over a UTC window. Use Nubra SDK-style timestamps like 2026-03-10T03:45:00.000Z."""
        try:
            return _success(
    ...
    def analyze_option_greek_changes(
        ...
        """Use this for any intraday options greek-change question on stocks. It resolves ATM options and uses Nubra historical data with intraday=True to rank open->latest, open->high, or open->low changes for delta/gamma/theta/vega/iv_mid."""
        try:
            return _success(
